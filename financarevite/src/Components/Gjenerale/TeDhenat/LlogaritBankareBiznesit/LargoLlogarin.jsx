    ...
    <>
      ...
      <Modal show={true} onHide={() => props.largo()} className="sp-modal">
        <Modal.Header closeButton>
          <Modal.Title className="text-danger">Largo Llogarinë Bankare</Modal.Title>
        </Modal.Header>
        <Modal.Body className="text-center py-4">
          ...
          <p className="text-muted">Deshironi ta fshini këtë llogari bankare? Kjo veprim nuk mund të kthehet.</p>
        </Modal.Body>
        <Modal.Footer>
