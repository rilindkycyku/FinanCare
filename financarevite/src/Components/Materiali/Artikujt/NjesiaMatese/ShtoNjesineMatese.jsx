...
function ShtoNjesineMatese(props) {
  ...
  function handleSubmit() {
    axios
      .post(
        `${API_BASE_URL}/api/NjesiaMatese/shtoNjesineMatese`,
        {
    ...
    <>
      ...
      {kontrolloNjesineMatese && (
        <Modal
          ...
          <Modal.Body className="text-center py-4">
            <p className="text-warning mb-2">Kjo njësi ekziston në sistem!</p>
      ...
      <Modal
        ...
        className="sp-modal">
        <Modal.Header closeButton>
          <Modal.Title>Shto Njësinë Matëse</Modal.Title>
        </Modal.Header>
        <Modal.Body>
