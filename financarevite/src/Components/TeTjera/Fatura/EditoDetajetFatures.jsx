...
import KontrolloAksesinNeFunksione from "../KontrolliAksesit/KontrolloAksesinNeFunksione";
  ...
  return (
    <>
      <KontrolloAksesinNeFunksione
        roletELejuara={["Faturist", "Menaxher", "Kalkulant", "Arkatar", "Komercialist", "1 Euro Menaxher"]}
        largo={onHide}
