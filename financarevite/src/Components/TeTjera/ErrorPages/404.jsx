    ...
    <div className="ep-wrapper">
      ...
      <Container className="ep-container">
        <div className="ep-card" data-aos="zoom-in">
          ...
          <div className="ep-orb ep-orb--blue" />

          {/* Icon */}
          <div className="ep-icon-ring ep-icon-ring--blue">
            <MapPinOff size={52} strokeWidth={1.5} />
          </div>

          {/* Error code */}
          <h1 className="ep-code ep-code--blue">404</h1>
          <h2 className="ep-title">Faqja nuk u Gjet</h2>
          ...
          <div className="ep-actions">
            ...
            <button className="ep-btn ep-btn--primary" onClick={() => navigate("/")}>
