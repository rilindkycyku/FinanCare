...
import PerditesoStatusinKalk from "../../../Components/Materiali/Hyrjet/KalkulimiFillestarVjetor/PerditesoStatusinKalk";
...
function KalkulimiFillestarVjetor(props) {
  ...
  async function handleRegjistroKalkulimin() {
    try {
      ...
      const exists = kalkulimet.some((k) => k["Viti Kalkulimit"] === selectedYear);
