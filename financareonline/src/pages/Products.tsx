...
export default function Products() {
  ...
  const filtered = useMemo(() => {
    ...
    // Kërkim sipas emrit ose barkodit
    if (searchTerm.trim()) {
  ...
  return (
    <>
      ...
      <div className="max-w-7xl mx-auto p-4 md:p-6 space-y-8">
        {/* SEARCH BAR ME SEARCH + KATEGORI */}
        {/* SEARCH + DROPDOWN KATEGORIE NË NJË RRESHT */}
